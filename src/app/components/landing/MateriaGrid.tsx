        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {products.map((product) => (
            <motion.div
              ...
              whileInView="show"
              viewport={{ once: true, margin: "-100px" }}
              className="bg-white hover:bg-[#FDFAF5] transition-all duration-500 group border border-[#E5DCCF] flex flex-col h-full"
            >
              {/* Image with hover */}
              <div
              ...
              >
                <SaveButton item={{ id: product.id, name: product.name, price: product.price, image: product.image, subtitle: product.latin }} />
                <Image
                  src={
                    product.hoverImage &&
                    hoveredProduct === product.id
              ...
              {/* Content */}
              <div className="pt-4 pb-4 md:pt-5 md:pb-5 flex flex-col flex-1 justify-between">
                <div>
                  <p
                  ...
                  <h3
                    className="text-[#2B2925] text-lg md:text-[21px] font-normal mb-1"
                    style={{ fontFamily: "var(--font-serif)" }}
                  >
                    {product.name}
                  </h3>
