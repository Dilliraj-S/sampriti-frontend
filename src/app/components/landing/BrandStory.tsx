  ...
  return (
    <div className="relative w-full select-none">
                  ...
                  {pos === "center" && (
                    <>
                      ...
                      <AnimatePresence mode="wait">
                        ...
                        >
                          <p style={{ fontFamily: "var(--font-sans,'Inter',sans-serif)", fontSize: "0.58rem", letterSpacing: "0.4em", textTransform: "uppercase", color: "#A48662", marginBottom: "5px" }}>{img.sublabel}</p>
      ...
      <div className="flex flex-col items-center gap-3 mt-8">
        <p style={{ fontFamily: "var(--font-sans,'Inter',sans-serif)", fontSize: "0.6rem", letterSpacing: "0.42em", textTransform: "uppercase", color: "#A48662" }}>
      ...
      <div className="pt-36 pb-12 md:pt-40 md:pb-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true, margin: "-50px" }} className="max-w-4xl mx-auto text-center mb-16">
            <h3 className="text-[#2B2925] text-[25px] md:text-[31px] font-light" style={{ fontFamily: "var(--font-serif)" }}>A Botanical Pilgrimage</h3>
          </motion.div>
