...
export default function PromoStrip() {
    ...
    return (
      <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50">
        <div className="relative max-w-[260px] sm:max-w-sm rounded-xl sm:rounded-2xl bg-white p-3 sm:p-6 shadow-xl sm:shadow-2xl text-center border border-gray-100">
          <button onClick={() => setDismissedProduct(true)} className="absolute -right-1.5 -top-1.5 sm:-right-2 sm:-top-2 flex h-5 w-5 cursor-pointer sm:h-7 sm:w-7 items-center justify-center rounded-full bg-gray-200 hover:bg-gray-300 transition-colors">
            <X size={12} className="sm:size-4" />
          </button>
  ...
  if (coupon) {
    return (
      <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50">
        <div className="relative max-w-[260px] sm:max-w-sm rounded-xl sm:rounded-2xl bg-white p-3 sm:p-6 shadow-xl sm:shadow-2xl text-center border border-gray-100">
          <button onClick={() => setDismissed(true)} className="absolute -right-1.5 -top-1.5 sm:-right-2 sm:-top-2 flex h-5 w-5 cursor-pointer sm:h-7 sm:w-7 items-center justify-center rounded-full bg-gray-200 hover:bg-gray-300 transition-colors">
            <X size={12} className="sm:size-4" />
          </button>
