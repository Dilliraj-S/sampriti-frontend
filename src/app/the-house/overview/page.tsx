  ...
  return (
    ...
    >
      <div className={`flex flex-col lg:flex-row ${isEven ? 'lg:flex-row-reverse' : ''}`}>
        ...
        >
          <div className="px-6 py-10 md:px-12 lg:px-16 w-full bg-[#FDFAF5]">
...
export default function TheHouseOverview() {
  return (
    <main className="min-h-screen overflow-x-hidden" style={{ fontFamily: "var(--font-sans)", background: "#FDFAF5" }}>
      ...
      <div className="pt-36 pb-16 md:pt-40 md:pb-20 px-4 md:px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true, margin: "-50px" }} className="text-center mb-16 md:mb-20">
            <h2 className="text-[21px] md:text-[25px] lg:text-[31px] font-light" style={{ fontFamily: "var(--font-serif)", color: "#2B2925" }}>— A Botanical Pilgrimage —</h2>
          </motion.div>
      ...
      <div className="w-full">
        ...
        <div className="relative aspect-[16/9] md:aspect-[16/7] lg:aspect-[21/8]">
          ...
          <div className="md:hidden absolute inset-0 flex items-center justify-center pt-8">
            <div className="text-center px-7 max-w-xl">
              <h3 className="text-xl font-light leading-tight mb-3" style={{ fontFamily: "var(--font-serif)", color: "#FDFAF5" }}>The House of Sampriti</h3>
          ...
          <div className="hidden md:flex absolute inset-0 items-center justify-center pt-8 md:pt-12">
            <div className="text-center px-6 max-w-2xl">
              <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl mb-4 md:mb-6 font-light leading-tight" style={{ fontFamily: "var(--font-serif)", color: "#FDFAF5" }}>The House of Sampriti</h3>
